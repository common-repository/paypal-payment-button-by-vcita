	...
	*/
	...
	?>
		...
		<table class="form-table">
			...
			<tr>
				<td> <?php _e('Scheduling Options','livesite'); ?>:</td>
				<td>
					<a class="button button-primary" data-open-popup href="https://www.vcita.com/my/meetings_wizard/welcome?mode=minimized&<?php echo $ls_helpers->get_plugin_identifier(); ?>_scheduler">
						<?php _e('Set your services and scheduling options','livesite'); ?>
					</a>
				</td>
			</tr>
		</table>
	...
	<?php
		...
		?>
			...
			<a href="https://www.vcita.com/account/upgrade?<?php echo $ls_helpers->get_plugin_identifier(); ?>_Form-builder" target="_blank" class="button button-primary"> <?php _e('Try vCita Premium','livesite'); ?></a>
