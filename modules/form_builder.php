...
//		add_action( 'delete_post', array( $this, 'remove_custom_page' ), 10 );
	...
	?>
		...
		<table class="form-table">
			<tr>
				<td class="ls-label-column"> <?php _e('Contact Us page','livesite'); ?></td>
				<td>
			...
			<tr>
				<td class="ls-label-column"> <?php _e('Form Options','livesite'); ?>:</td>
				<td>
					<a class="button button-primary" data-open-popup href="https://www.vcita.com/my/lead_gen_wizard/form_options?frontage_popup=true&mode=minimized"><?php _e('Set Your Form Options','livesite'); ?></a>
				</td>
			</tr>
	...
	?>
		...
		<a href="https://www.vcita.com/account/upgrade?<?php echo $ls_helpers->get_plugin_identifier(); ?>_Form-builder" target="_blank" class="button button-primary">
			<?php _e('Try vCita Premium','livesite'); ?>
		</a>
