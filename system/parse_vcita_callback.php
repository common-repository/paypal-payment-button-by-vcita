    ...
    function ls_parse_vcita_callback(){
		...
		ls_set_settings( array(
            ...
            'vcita_params' => array(
              ...
              'confirmation_token'   => htmlspecialchars($confirmation_token),
              'confirmed'            => filter_var($confirmed, FILTER_SANITIZE_ENCODED),
              'engage_delay'         => htmlspecialchars($engage_delay),
              'implementation_key'   => htmlspecialchars($implementation_key),
